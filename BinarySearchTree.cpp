...
#include <time.h>
using namespace std;
//structure on definit un nouveau type capable de pointer a 2 endroit et de de sauvegarder un entier
...
void BST::supphelper(binNoeud*& racine, int data)
{
    ...
    else// rendu ici ces qu'on trouver le neud a supprimer
    {
        ...
        else if(racine->right==NULL)// si le noeud a supprimer n'a pas fils a droite
        {
